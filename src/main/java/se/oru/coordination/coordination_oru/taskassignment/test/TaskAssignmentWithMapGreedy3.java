...
public class TaskAssignmentWithMapGreedy3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		viz.setMap("maps/map-empty.yaml");
		...
		Pose startPoseRobot4 = new Pose(8.0,30.0,0.0);
		...
		Pose startPoseGoal3 = new Pose(30.0,8.0,0.0);
